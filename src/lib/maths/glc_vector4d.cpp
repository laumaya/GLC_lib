...
{
	bool bResult= glc::fuzzyCompare(vector[0], Vect.vector[0]);
	bResult= bResult && glc::fuzzyCompare(vector[1], Vect.vector[1]);
	bResult= bResult && glc::fuzzyCompare(vector[2], Vect.vector[2]);
	bResult= bResult && glc::fuzzyCompare(vector[3], Vect.vector[3]);
